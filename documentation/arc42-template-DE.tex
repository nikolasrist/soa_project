...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\linewidth]{"../../../../Google Drive/Lerngruppe_HBRS/mcs/2019_SS/SOA/projekt/uebung6_4_kontext_sicht"}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{"../../../../Google Drive/Lerngruppe_HBRS/mcs/2019_SS/SOA/projekt/uebung6_4_baustein_sicht"}
...
\begin{figure}[H]
	\centering
	\rotatebox{90}{\includegraphics[width=1.7\linewidth]{"../../../../Google Drive/Lerngruppe_HBRS/mcs/2019_SS/SOA/projekt/laufzeitsicht_high_performance_bpmn"}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{"../../../../Google Drive/Lerngruppe_HBRS/mcs/2019_SS/SOA/projekt/verteilungssicht"}
